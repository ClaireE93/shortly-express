...
module.exports.addUser = (req, res, next) => {
  ...
  const cb = (req, res) => {
    ...
    .then((results) => {
      attachSessionToUser(req, res, results.insertId)
    })
    .catch((err) => {
...
module.exports.checkLogin = (req, res, next) => {
  ...
  const cb = (data) => {
    ...
    if (isRightPassword) {
      ...
      .then((userId) => {
        attachSessionToUser(req, res, userId);
      })
      .catch((err) => {
        console.error(err);
      });
  ...
  cookies(req, res, () => {
    ...
    .then((data) => {
      if (!data || data.userId === null) {
        ...
        resCookieDecorator(res, data.hash);
        next();
      }
    })
    .catch((err) => {
